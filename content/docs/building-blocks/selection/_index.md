...
- **[Decoder]({{< relref "decoder" >}})** — Activate one output from a binary code.
- **[Encoder]({{< relref "encoder" >}})** — Collapse an active input back to a binary code.
- **[Multiplexer]({{< relref "multiplexer" >}})** — Select one of many inputs onto a single output.
- **[Demultiplexer]({{< relref "demultiplexer" >}})** — Route one input to one of many outputs.
