...
- **[Shift Registers]({{< relref "shift-registers" >}})** — Serial-to-parallel and parallel-to-serial conversion.
- **[Bus Transceivers]({{< relref "bus-transceivers" >}})** — Bidirectional drivers with direction control for shared buses.
- **[Buffers]({{< relref "buffers" >}})** — Drive, isolation, and the three-state output.
